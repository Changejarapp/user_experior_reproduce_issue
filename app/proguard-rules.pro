...
-keep class io.grpc.** { *; }
-keep class in.juspay.hyperapay.** { *; }
-keep class in.juspay.hyperapayupi.** { *; }
-keep class in.juspay.hypergpay.** { *; }
-keep class in.juspay.hypergpayintl.** { *; }
-keep class in.juspay.hyperlottie.** { *; }
-keep class in.juspay.hypernfc.** { *; }
-keep class in.juspay.hyperpaypal.** { *; }
-keep class in.juspay.hyperpayu.** { *; }
-keep class in.juspay.hyperqr.** { *; }
-keep class in.juspay.hypersimpl.** { *; }
-keep class in.juspay.hyperupi.** { *; }
-keep class in.juspay.mobility.** { *; }
